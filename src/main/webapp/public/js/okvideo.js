  ...
  $.okvideo = function (options) {
    ...
    base.init = function () {
      ...
      if (OKEvents.utils.isMobile()) {
        $('#work_vimeo').append('<div id="okplayer" style="position:absolute;left:0;top:0;overflow:hidden;z-index:-999;height:100%;width:100%;"></div>');
      } else if (base.options.adproof) {
        $('#work_vimeo').append('<div style="position:absolute;left:0;top:0;overflow:hidden;z-index:-998;height:100%;width:100%;" id="okplayer-mask"></div><div id="okplayer" style="position:absolute;left:0;top:0;overflow:hidden;z-index:999;height:100%;width:100%;"></div>');
      } else {
        $('#work_vimeo').append('<div style="position:absolute;left:0;top:0;overflow:hidden;z-index:-998;height:100%;width:100%;" id="okplayer-mask"></div><div id="okplayer" style="position:absolute;left:0;top:0;overflow:hidden;z-index:999;height:100%;width:100%;"></div>');
      }
